...
(function () {
    ...
    iScroll.prototype = {
        ...
        _start: function (e) {
            ...
            that.startTime = e.timeStamp || GetNow();
        ...
        _end: function (e) {
			...
			duration = (e.timeStamp || GetNow()) - that.startTime,
			newPosX = that.x,
			newPosY = that.y,
			distX, distY,
			newDuration,
        ...
        */
        _startAni: function () {
            ...
            animate = function () {
                ...
                if (now >= AddSeconds(startTime,step.time)) {
                    that._pos(step.x, step.y);
                    that.animating = false;
...
function AddSeconds(TheTime, ms) {
    if (!MSIE()) {
        return TheTime + ms;
    } else {
        var newdate = new Date(TheTime.getTime() + ms);
        return newdate;
    }
}